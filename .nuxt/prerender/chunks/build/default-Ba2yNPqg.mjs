  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList("footerIcons" in _ctx ? _ctx.footerIcons : unref(footerIcons), (icon) => {
        var _a2;
        _push(`<div data-v-b14624c8><div data-v-b14624c8>${(_a2 = icon.Html) != null ? _a2 : ""}</div></div>`);
      });
      _push(`<!--]--><!--[-->`);
      ssrRenderList("footerText" in _ctx ? _ctx.footerText : unref(footerText), (text) => {
        var _a2;
        _push(`<div class="py-5" data-v-b14624c8><p data-v-b14624c8>${(_a2 = text.Html) != null ? _a2 : ""}</p></div>`);
      });
...
//# sourceMappingURL=default-Ba2yNPqg.mjs.map
