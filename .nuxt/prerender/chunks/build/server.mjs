import { ref, defineComponent, h, inject, computed, unref, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, shallowRef, isReadonly, withCtx, isRef, isShallow, isReactive, toRaw } from 'file:///Users/irek/sites/queensbingo/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/irek/sites/queensbingo/node_modules/ofetch/dist/node.mjs';
import { b as baseURL, s as setHeadInjectionHandler } from '../_/renderer.mjs';
import { createHooks } from 'file:///Users/irek/sites/queensbingo/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/irek/sites/queensbingo/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/irek/sites/queensbingo/node_modules/h3/dist/index.mjs';
import { composableNames } from 'file:///Users/irek/sites/queensbingo/node_modules/@unhead/shared/dist/index.mjs';
import { CapoPlugin } from 'file:///Users/irek/sites/queensbingo/node_modules/unhead/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/irek/sites/queensbingo/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/irek/sites/queensbingo/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/irek/sites/queensbingo/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/irek/sites/queensbingo/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/irek/sites/queensbingo/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "all-games",
    path: "/all-games",
    component: () => import('./all-games-BMaGhhzM.mjs')
  },
  {
    name: "blackjack-games",
    path: "/blackjack-games",
    component: () => import('./blackjack-games-BPQeMr0y.mjs')
  },
  {
    name: "casino-games",
    path: "/casino-games",
    component: () => import('./casino-games-Dp3Niuyu.mjs')
  },
  {
    name: "compliance-slug",
    path: "/compliance/:slug()",
    component: () => import('./_slug_-DAL1etFR.mjs')
  },
  {
    name: "compliance-cookies",
    path: "/compliance/cookies",
    component: () => import('./cookies-Cuw6N4CS.mjs')
  },
  {
    name: "compliance",
    path: "/compliance",
    component: () => import('./index-NpI1siox.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CpPYaZ29.mjs')
  },
  {
    name: "jackpot-games",
    path: "/jackpot-games",
    component: () => import('./jackpot-games--EKX7HSU.mjs')
  },
  {
    name: "live-games",
    path: "/live-games",
    component: () => import('./live-games-D8TEtoEX.mjs')
  },
  {
    name: "popular-games",
    path: "/popular-games",
    component: () => import('./popular-games-Cf5mwWhe.mjs')
  },
  {
    name: "promotions",
    path: "/promotions",
    component: () => import('./index-DrXDPn3M.mjs')
  },
  {
    name: "roulette-games",
    path: "/roulette-games",
    component: () => import('./roulette-games-CQkt0HBB.mjs')
  },
  {
    name: "scratchcards",
    path: "/scratchcards",
    component: () => import('./scratchcards-BoejWr4Q.mjs')
  },
  {
    name: "slot-games",
    path: "/slot-games",
    component: () => import('./slot-games-CY7SYcsz.mjs')
  }
];
...
const footerContentCache = /* @__PURE__ */ new Map();
const GAMES_CACHE_DURATION = 2 * 60 * 60 * 1e3;
const games = ref([]);
const newGames = ref([]);
...
async function actuallyFetchGames() {
  try {
    ...
    const filteredGames = data.filter((game) => {
      ...
      if (lang.value === "CA") {
        const isRealCountry = (void 0).__isRealCountry;
        const originalDetectedCountry = (void 0).__originalDetectedCountry;
        if (isRealCountry && originalDetectedCountry === "CA") {
          const isPlaytech = ((_c = game.provider) == null ? void 0 : _c.toLowerCase()) === "playtech" || ((_d = game.subProvider) == null ? void 0 : _d.toLowerCase()) === "playtech";
          if (isPlaytech) {
    ...
    popularGames.value = filteredGames.filter((game) => {
      var _a, _b;
      return ((_a = game.gameFilters) == null ? void 0 : _a.includes("Popular")) || ((_b = game.gameFilters) == null ? void 0 : _b.includes("Featured"));
    });
    ...
    console.log("✅ GAMES: Games data cached successfully for", GAMES_CACHE_DURATION / 6e4, "minutes");
    await updateLinks();
  } catch (error) {
    console.error("❌ GAMES: Error fetching games:", error);
    throw error;
...
async function fetchFooterContent(lang2) {
  const cacheKey = `footer_${lang2}`;
  ...
  try {
    ...
    const apiUrl = false ? `https://access-content-pp.tech1960.workers.dev/?type=content&codes=footericon,footertext&whitelabelId=${WHITELABEL_ID}&country=${lang2 || lang2.value || "GB"}` : null;
    if (false) ;
    else {
      await fetchFooterIconsServer(lang2);
      await fetchFooterTextServer(lang2);
    }
  } catch (error) {
...
async function fetchFooterIconsServer(lang2) {
  try {
...
async function fetchFooterTextServer(lang2) {
  try {
...
async function fetchFooterIcons(lang2) {
  await fetchFooterContent(lang2);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BA6AKT9K.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CNDrCSHr.mjs'));
...
export { useRouter as A, nuxtLinkDefaults as B, resolveRouteObject as C, navigateTo as D, useNuxtApp as E, useRuntimeConfig as F, asyncDataDefaults as G, createError as H, PP_LOBBY_LINK as P, _export_sfc as _, globalContent as a, popularGames as b, casinoGames as c, fetchPromotions as d, entry$1 as default, liveGames as e, fetchGames as f, games as g, pp_promotions as h, rouletteGames as i, jackpotGames as j, scratchGames as k, loadLang as l, msgTranslate as m, newGames as n, fetchFooterIcons as o, promotionsPosts as p, lang as q, regLink as r, slotGames as s, fetchFooterText as t, footerIcons as u, footerText as v, loginLink as w, getCookie as x, fetchDefaults as y, useRequestFetch as z };
