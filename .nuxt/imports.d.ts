...
export { SITE_CONFIG, lang, tracker, jurisdictionCode, footerIcons, footerText, globalContent, WHITELABEL_ID, PP_API_URL, PP_LOBBY_LINK, handleTracker, checkCountry, loadLang, fetchPromotions, fetchSupportedCountries, fetchAllCountries, fetchCountriesData, fetchFooterIcons, fetchFooterText, //fetchPromotions, fetchApiPromotions, games, newGames, popularGames, jackpotGames, casinoGames, slotGames, scratchGames, liveGames, blackjackGames, rouletteGames, regLink, loginLink, msgTranslate, pp_promotions, promotionsPosts, countryCode, countryName, countries, country, countriesData, countryNotSupported, fetchGames, getCookie, setCookie, loadTranslations, fetchFooterContent, fetchCachedContent } from '../composables/globalData';
