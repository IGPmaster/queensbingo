...
import { _ as _export_sfc, o as fetchFooterIcons, q as lang, t as fetchFooterText, l as loadLang, m as msgTranslate, u as footerIcons, v as footerText, w as loginLink, r as regLink } from "../server.mjs";
import { withAsyncContext, withCtx, unref, createTextVNode, toDisplayString, useSSRContext, ref, mergeProps, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderTeleport, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderSlot } from "vue/server-renderer";
import { u as useCookieConsent } from "./useCookieConsent-n_xe8OZG.js";
...
import "radix3";
import "ohash";
const _imports_1 = "" + __buildAssetsURL("queens-bingo-logo.BHNQN9fv.svg");
const _sfc_main$3 = {
  __name: "Footer",
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-b14624c8><footer class="bg-tertiary_dark py-10" data-v-b14624c8><div class="row" data-v-b14624c8><div class="container mx-auto" data-v-b14624c8><ul class="flex flex-wrap justify-center pb-10 gap-8" data-v-b14624c8><li data-v-b14624c8>`);
      ...
      _push(`</li><li data-v-b14624c8><a href="https://queensbingo.com/promotions" class="uppercase font-light text-sm text-zinc-200 py-2 px-4 bg-stone-800 rounded hover:bg-[#323131] transition ease-in-out" data-v-b14624c8>${ssrInterpolate(((_a = unref(msgTranslate)) == null ? void 0 : _a.promotions) || "Promotions")}</a></li><li data-v-b14624c8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/compliance",
        class: "uppercase font-light text-sm text-zinc-200 py-2 px-4 bg-stone-800 rounded hover:bg-[#323131] transition ease-in-out"
      }, {
      ...
      _push(`</li></ul></div></div><div class="row" data-v-b14624c8><div class="container mx-auto footerContainer" data-v-b14624c8><ul class="container mx-auto flex list-none flex-wrap text-lg justify-center gap-6 py-8 text-gray-800" data-v-b14624c8><li data-v-b14624c8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</li><li data-v-b14624c8><button class="compliance-btn" data-v-b14624c8>${ssrInterpolate(((_b = unref(msgTranslate)) == null ? void 0 : _b.cookie_settings) || "Cookie Settings")}</button></li></ul><!--[-->`);
      ssrRenderList("footerIcons" in _ctx ? _ctx.footerIcons : unref(footerIcons), (icon) => {
        _push(`<div data-v-b14624c8><div data-v-b14624c8>${icon.Html ?? ""}</div></div>`);
      });
      _push(`<!--]--><!--[-->`);
      ssrRenderList("footerText" in _ctx ? _ctx.footerText : unref(footerText), (text) => {
        _push(`<div class="py-5" data-v-b14624c8><p data-v-b14624c8>${text.Html ?? ""}</p></div>`);
      });
      _push(`<!--]--><div class="flex items-center justify-center" data-v-b14624c8><img${ssrRenderAttr("src", _imports_1)} alt="Queens Bingo footer Logo" class="bg-primary_bg w-56 p-5 shadow-md rounded-lg" height="" width="" loading="lazy" data-v-b14624c8></div></div></div><div class="w-full fixed bottom-0 lg:hidden" data-v-b14624c8><div class="grid grid-cols-2" data-v-b14624c8><div class="w-full bg-[#91D342] flex justify-center py-3" data-v-b14624c8><a${ssrRenderAttr("href", unref(loginLink))} class="flex items-center gap-4 text-[#313131] font-semibold" data-v-b14624c8>${ssrInterpolate(((_c = unref(msgTranslate)) == null ? void 0 : _c.login) || "Login")} <i class="material-icons" data-v-b14624c8>arrow_forward</i></a></div><div class="w-full bg-[#3598FB] flex justify-center" data-v-b14624c8><a${ssrRenderAttr("href", unref(regLink))} class="flex items-center gap-4 text-[#313131] font-semibold" data-v-b14624c8>${ssrInterpolate(((_d = unref(msgTranslate)) == null ? void 0 : _d.sign_up) || "Sign Up")} <i class="material-icons" data-v-b14624c8>security</i></a></div></div></div></footer></div>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b14624c8"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<a href="https://www.queensbingo.com/promotions" class="menu-item hover:bg-slate-800 px-5">${ssrInterpolate(((_a = unref(msgTranslate)) == null ? void 0 : _a.promotions) || "Promotions")}</a>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/compliance",
        class: "menu-item hover:bg-slate-800 px-5"
      }, {
      ...
      _push(`<a${ssrRenderAttr("href", unref(regLink))} class="menu-item hover:bg-slate-800 px-5">${ssrInterpolate(((_b = unref(msgTranslate)) == null ? void 0 : _b.login) || "Login")}</a></div></div></div><div class="">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</div><div class="right"><ul class="grid-cols-2 gap-6 hidden lg:flex right"><li class="items-center"><a${ssrRenderAttr("href", unref(loginLink))} class="login-btn">${ssrInterpolate(((_c = unref(msgTranslate)) == null ? void 0 : _c.login) || "Login")}</a></li><li class="items-center"><a${ssrRenderAttr("href", unref(regLink))} class="reg-btn">${ssrInterpolate(((_d = unref(msgTranslate)) == null ? void 0 : _d.sign_up) || "Sign Up")}</a></li></ul><div class="flex lg:hidden right items-center pr-4"><a${ssrRenderAttr("href", unref(loginLink))} class="cas-btn px-4">Login</a></div></div></div></div></nav>`);
...
//# sourceMappingURL=default-Ba2yNPqg.js.map
