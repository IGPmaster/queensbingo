...
const _sfc_main$3 = {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="container mx-auto px-4 py-6" data-v-41594a2a><h1 class="text-center text-2xl sm:text-3xl lg:text-4xl font-bold" data-v-41594a2a>New Online Bingo Site Buzzing With Fun!</h1><p class="text-center" data-v-41594a2a>Play our sweet and sticky bingo games and spin our delicious slots! Check out the finger-licking specials waiting for you in our promotions jar.</p></div><div class="container mx-auto px-4 py-6" data-v-41594a2a><div class="grid grid-cols-2 md:grid-cols-4 gap-4" data-v-41594a2a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-41594a2a><img${ssrRenderAttr("src", _imports_0)} alt="Image 1" class="w-full h-auto object-cover rounded" data-v-41594a2a></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-41594a2a><img${ssrRenderAttr("src", _imports_1)} alt="Image 2" class="w-full h-auto object-cover rounded" data-v-41594a2a></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-41594a2a><img${ssrRenderAttr("src", _imports_2)} alt="Image 3" class="w-full h-auto object-cover rounded" data-v-41594a2a></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-41594a2a><img${ssrRenderAttr("src", _imports_3)} alt="Image 4" class="w-full h-auto object-cover rounded" data-v-41594a2a></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-41594a2a><img${ssrRenderAttr("src", _imports_4)} alt="Image 5" class="w-full h-auto object-cover rounded" data-v-41594a2a></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-41594a2a><img${ssrRenderAttr("src", _imports_5)} alt="Image 6" class="w-full h-auto object-cover rounded" data-v-41594a2a></a><div class="col-span-2 bg-primary_bg text-[#F2E8B9] rounded p-4 text-center" data-v-41594a2a><h2 class="gamesSectionHead py-2" data-v-41594a2a>Come and Taste from the Promotions Jar at Queen&#39;s Bingo!</h2><p class="text-lg mb-2" data-v-41594a2a> Enjoy exclusive Bingo Promotions and Free Bingo Rooms! </p><p class="text-lg mb-2" data-v-41594a2a> Sign up to receive our exclusive daily and weekly email offers! </p><p class="text-lg mb-2" data-v-41594a2a> Look out for Queen&#39;s Bingo Bonus Code promotions! </p><div class="flex justify-center py-4" data-v-41594a2a><a${ssrRenderAttr("href", unref(regLink))} class="reg-btn text-lg md:text-xl" data-v-41594a2a>${ssrInterpolate(((_a = unref(msgTranslate)) == null ? void 0 : _a.sign_up) || "Sign Up")}</a></div></div></div></div><div class="section-odd py-10 lg:py-10" data-v-41594a2a><div class="row bgr_red lg:mb-4" data-v-41594a2a><div class="container grid grid-cols-1 lg:grid-cols-8 lg:gap-10 items-center mx-auto p-4" data-v-41594a2a><div class="col-span-full lg:col-span-6" data-v-41594a2a><p class="gamesSectionHead text-center lg:text-left" data-v-41594a2a>${ssrInterpolate(((_b = unref(msgTranslate)) == null ? void 0 : _b.new_games) || "New Games")}</p></div><div class="lg:block lg:col-span-2" data-v-41594a2a><div class="" data-v-41594a2a>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b2, _c, _d;
          if (_push2) {
            _push2(`${ssrInterpolate(((_a2 = unref(msgTranslate)) == null ? void 0 : _a2.see_more) || "See More")} ${ssrInterpolate(((_b2 = unref(msgTranslate)) == null ? void 0 : _b2.new_games) || "New Games")} <i class="material-icons right" style="${ssrRenderStyle({ "font-size": "16px" })}" data-v-41594a2a${_scopeId}>arrow_forward</i>`);
          } else {
            return [
      ...
      if (loading.value) {
        _push(`<div class="loading-placeholder" data-v-41594a2a><svg class="spinner" viewBox="0 0 50 50" data-v-41594a2a><circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="3" data-v-41594a2a></circle></svg></div>`);
      } else {
        _push(`<div class="px-4 sm:px-6 md:px-0" data-v-41594a2a><div class="container mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4" data-v-41594a2a><!--[-->`);
        ssrRenderList(unref(newGames).slice(-12).reverse(), (game) => {
          _push(`<div class="${ssrRenderClass("item " + game.id)}" data-v-41594a2a><div class="" data-v-41594a2a><div class="show show-first first-content-border" data-v-41594a2a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" data-v-41594a2a><img class="responsive-img item-qqq min-w-full"${ssrRenderAttr("src", game.image)}${ssrRenderAttr("alt", "Image of " + game.gameName + " online slot. " + game.description)}${ssrRenderAttr("title", game.gameName + " - " + game.id)} data-v-41594a2a></a><div class="mask" data-v-41594a2a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" data-v-41594a2a><div class="gameDescr" data-v-41594a2a>`);
          if (_ctx.newGame && game.description && game.description.length > 0) {
            _push(`<div data-v-41594a2a>${ssrInterpolate(game.description)}</div>`);
          } else {
            _push(`<i class="large material-icons" data-v-41594a2a>play_arrow</i>`);
          }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-41594a2a"]]);
const _sfc_main$2 = {
  __name: "PopularGames",
  __ssrInlineRender: true,
  emits: ["loaded"],
...
//# sourceMappingURL=index-CpPYaZ29.js.map
