import { ref, mergeProps, unref, useSSRContext, withAsyncContext, withCtx, createTextVNode, toDisplayString, createVNode } from "vue";
...
import { _ as _export_sfc, p as promotionsPosts, r as regLink, l as loadLang, f as fetchGames, m as msgTranslate, n as newGames, b as popularGames, s as slotGames, d as fetchPromotions } from "../server.mjs";
import { _ as __nuxt_component_0$1 } from "./nuxt-link-BwA2waJh.js";
import { u as useAsyncData } from "./asyncData-DjIsNNZu.js";
import { u as useFetch } from "./fetch-BacJTO93.js";
import "ofetch";
...
const _imports_0 = "" + __buildAssetsURL("bingo-room-1.CgjF3woD.webp");
const _imports_1 = "" + __buildAssetsURL("bingo-room-2.BXhfKYxx.webp");
const _imports_2 = "" + __buildAssetsURL("bingo-room-3.DSWemBm1.webp");
const _imports_3 = "" + __buildAssetsURL("bingo-room-4.CUU-hb_b.webp");
const _imports_4 = "" + __buildAssetsURL("bingo-room-5.ICpgh3k1.webp");
const _imports_5 = "" + __buildAssetsURL("bingo-room-6.C-Q1fnwA.webp");
const _sfc_main$3 = {
  __name: "NewGames",
  __ssrInlineRender: true,
  emits: ["loaded"],
  async setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="container mx-auto px-4 py-6" data-v-51d7d275><h1 class="text-center text-2xl sm:text-3xl lg:text-4xl font-bold" data-v-51d7d275>New Online Bingo Site Buzzing With Fun!</h1><p class="text-center" data-v-51d7d275>Play our sweet and sticky bingo games and spin our delicious slots! Check out the finger-licking specials waiting for you in our promotions jar.</p></div><div class="container mx-auto px-4 py-6" data-v-51d7d275><div class="grid grid-cols-2 md:grid-cols-4 gap-4" data-v-51d7d275><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-51d7d275><img${ssrRenderAttr("src", _imports_0)} alt="Image 1" class="w-full h-auto object-cover rounded" data-v-51d7d275></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-51d7d275><img${ssrRenderAttr("src", _imports_1)} alt="Image 2" class="w-full h-auto object-cover rounded" data-v-51d7d275></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-51d7d275><img${ssrRenderAttr("src", _imports_2)} alt="Image 3" class="w-full h-auto object-cover rounded" data-v-51d7d275></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-51d7d275><img${ssrRenderAttr("src", _imports_3)} alt="Image 4" class="w-full h-auto object-cover rounded" data-v-51d7d275></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-51d7d275><img${ssrRenderAttr("src", _imports_4)} alt="Image 5" class="w-full h-auto object-cover rounded" data-v-51d7d275></a><a${ssrRenderAttr("href", unref(regLink))} target="_blank" rel="noopener" data-v-51d7d275><img${ssrRenderAttr("src", _imports_5)} alt="Image 6" class="w-full h-auto object-cover rounded" data-v-51d7d275></a><div class="col-span-2 bg-primary_bg text-[#F2E8B9] rounded p-10 text-center" data-v-51d7d275><h2 class="gamesSectionHead py-4" data-v-51d7d275>Come and Taste from the Promotions Jar at Queen&#39;s Bingo!</h2><p class="text-lg mb-4" data-v-51d7d275> Enjoy exclusive Bingo Promotions and Free Bingo Rooms! </p><p class="text-lg mb-4" data-v-51d7d275> Sign up to receive our exclusive daily and weekly email offers! </p><p class="text-lg mb-4" data-v-51d7d275> Look out for Queen&#39;s Bingo Bonus Code promotions! </p><div class="flex justify-center py-4" data-v-51d7d275><a${ssrRenderAttr("href", unref(regLink))} class="reg-btn text-lg md:text-xl" data-v-51d7d275>${ssrInterpolate(((_a = unref(msgTranslate)) == null ? void 0 : _a.sign_up) || "Sign Up")}</a></div></div></div></div><div class="section-odd py-10 lg:py-10" data-v-51d7d275><div class="row bgr_red lg:mb-4" data-v-51d7d275><div class="container grid grid-cols-1 lg:grid-cols-8 lg:gap-10 items-center mx-auto p-4" data-v-51d7d275><div class="col-span-full lg:col-span-6" data-v-51d7d275><p class="gamesSectionHead text-center lg:text-left" data-v-51d7d275>${ssrInterpolate(((_b = unref(msgTranslate)) == null ? void 0 : _b.new_games) || "New Games")}</p></div><div class="lg:block lg:col-span-2" data-v-51d7d275><div class="" data-v-51d7d275>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b2, _c, _d;
          if (_push2) {
            _push2(`${ssrInterpolate(((_a2 = unref(msgTranslate)) == null ? void 0 : _a2.see_more) || "See More")} ${ssrInterpolate(((_b2 = unref(msgTranslate)) == null ? void 0 : _b2.new_games) || "New Games")} <i class="material-icons right" style="${ssrRenderStyle({ "font-size": "16px" })}" data-v-51d7d275${_scopeId}>arrow_forward</i>`);
          } else {
            return [
      ...
      if (loading.value) {
        _push(`<div class="loading-placeholder" data-v-51d7d275><svg class="spinner" viewBox="0 0 50 50" data-v-51d7d275><circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="3" data-v-51d7d275></circle></svg></div>`);
      } else {
        _push(`<div class="px-4 sm:px-6 md:px-0" data-v-51d7d275><div class="container mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4" data-v-51d7d275><!--[-->`);
        ssrRenderList(unref(newGames).slice(-12).reverse(), (game) => {
          _push(`<div class="${ssrRenderClass("item " + game.id)}" data-v-51d7d275><div class="" data-v-51d7d275><div class="show show-first first-content-border" data-v-51d7d275><a${ssrRenderAttr("href", unref(regLink))} target="_blank" data-v-51d7d275><img class="responsive-img item-qqq min-w-full"${ssrRenderAttr("src", game.image)}${ssrRenderAttr("alt", "Image of " + game.gameName + " online slot. " + game.description)}${ssrRenderAttr("title", game.gameName + " - " + game.id)} data-v-51d7d275></a><div class="mask" data-v-51d7d275><a${ssrRenderAttr("href", unref(regLink))} target="_blank" data-v-51d7d275><div class="gameDescr" data-v-51d7d275>`);
          if (_ctx.newGame && game.description && game.description.length > 0) {
            _push(`<div data-v-51d7d275>${ssrInterpolate(game.description)}</div>`);
          } else {
            _push(`<i class="large material-icons" data-v-51d7d275>play_arrow</i>`);
          }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-51d7d275"]]);
const _sfc_main$2 = {
  __name: "PopularGames",
  __ssrInlineRender: true,
  emits: ["loaded"],
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList("promotionsPosts" in _ctx ? _ctx.promotionsPosts : unref(promotionsPosts), (promotion) => {
        _push(`<div><div class="overflow-hidden"><div class="break-words">${promotion.content.rendered ?? ""}</div></div></div>`);
      });
      _push(`<!--]--></div></div><!--]-->`);
    };
  }
...
//# sourceMappingURL=index-DFltk1S_.js.map
