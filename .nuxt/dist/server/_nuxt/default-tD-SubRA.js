  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList("footerIcons" in _ctx ? _ctx.footerIcons : unref(footerIcons), (icon) => {
        _push(`<div data-v-2a048202><div data-v-2a048202>${icon.Html ?? ""}</div></div>`);
      });
      _push(`<!--]--><!--[-->`);
      ssrRenderList("footerText" in _ctx ? _ctx.footerText : unref(footerText), (text) => {
        _push(`<div class="py-5" data-v-2a048202><p data-v-2a048202>${text.Html ?? ""}</p></div>`);
      });
...
//# sourceMappingURL=default-tD-SubRA.js.map
