import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineComponent, computed, unref, provide, Suspense, nextTick, mergeProps, Transition, watch, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "all-games",
    path: "/all-games",
    component: () => import("./_nuxt/all-games-BMaGhhzM.js")
  },
  {
    name: "blackjack-games",
    path: "/blackjack-games",
    component: () => import("./_nuxt/blackjack-games-BPQeMr0y.js")
  },
  {
    name: "casino-games",
    path: "/casino-games",
    component: () => import("./_nuxt/casino-games-Dp3Niuyu.js")
  },
  {
    name: "compliance-slug",
    path: "/compliance/:slug()",
    component: () => import("./_nuxt/_slug_-DAL1etFR.js")
  },
  {
    name: "compliance-cookies",
    path: "/compliance/cookies",
    component: () => import("./_nuxt/cookies-Cuw6N4CS.js")
  },
  {
    name: "compliance",
    path: "/compliance",
    component: () => import("./_nuxt/index-NpI1siox.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Xa7riluU.js")
  },
  {
    name: "jackpot-games",
    path: "/jackpot-games",
    component: () => import("./_nuxt/jackpot-games--EKX7HSU.js")
  },
  {
    name: "live-games",
    path: "/live-games",
    component: () => import("./_nuxt/live-games-D8TEtoEX.js")
  },
  {
    name: "popular-games",
    path: "/popular-games",
    component: () => import("./_nuxt/popular-games-Cf5mwWhe.js")
  },
  {
    name: "promotions",
    path: "/promotions",
    component: () => import("./_nuxt/index-DrXDPn3M.js")
  },
  {
    name: "roulette-games",
    path: "/roulette-games",
    component: () => import("./_nuxt/roulette-games-CQkt0HBB.js")
  },
  {
    name: "scratchcards",
    path: "/scratchcards",
    component: () => import("./_nuxt/scratchcards-BoejWr4Q.js")
  },
  {
    name: "slot-games",
    path: "/slot-games",
    component: () => import("./_nuxt/slot-games-CY7SYcsz.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BA6AKT9K.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CNDrCSHr.js"));
...
export {
  ...
  msgTranslate as m,
  newGames as n,
  fetchFooterIcons as o,
  promotionsPosts as p,
  lang as q,
  regLink as r,
  slotGames as s,
  fetchFooterText as t,
  footerIcons as u,
  footerText as v,
  loginLink as w,
  getCookie as x,
