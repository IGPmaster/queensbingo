		...
		<div class="row bgr_red lg:mb-4 pt-20">
			<div class="container grid grid-cols-1 lg:grid-cols-8 lg:gap-10 items-center mx-auto p-4">
				<div class="col-span-full lg:col-span-6">
					<p class="gamesSectionHead text-center lg:text-left">{{ msgTranslate?.roulette_games || 'Roulette Games' }}</p>
				</div>
...
import { rouletteGames, regLink, msgTranslate, loadLang, fetchGames } from '~/composables/globalData';
