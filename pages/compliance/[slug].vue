...
import { ref } from 'vue';
import { msgTranslate, globalContent } from '~/composables/globalData.js';
...
async function fetchContent(slug) {
    try {
        const response = await fetch(
            ...
            //`http://content.progressplay.net/api23/api/InfoContent?whitelabelId=10&country=en&Code=${slug}`
        );
