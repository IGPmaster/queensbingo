                ...
                <div class="left">
                  <div class="menu-btn items-center" id="menu-btn">
                        <img src="../assets/hamburgerMenu.svg" alt="Mobile Menu Button" class="w-9 h-9 pl-4 items-center">
                          <div class="menu bg-cyan-950 rounded text-left w-36 drop-shadow-[0_15px_15px_rgba(0,0,0,0.50)] transition duration-300 ease-in-out transform scale-0 origin-top" id="menu">
               ...
               <div class="right">
                <ul class=" grid-cols-2 gap-6 hidden lg:flex right">
                  <li class="items-center">
                    <a :href="loginLink" class="login-btn">{{ msgTranslate.login }}</a>
                  </li>
                  <li class="items-center">
                    <a :href="regLink" class="reg-btn">{{ msgTranslate.sign_up }}</a>
                  </li>
                </ul>
