		...
		<div class="row bgr_red lg:mb-4">
			<div class="container grid grid-cols-1 lg:grid-cols-8 lg:gap-10 items-center mx-auto p-4">
				<div class="col-span-full lg:col-span-6">
					<p class="gamesSectionHead text-center lg:text-left">{{ msgTranslate?.jackpot_games || 'Jackpot Games' }}</p>
				</div>
				<div class="lg:block lg:col-span-2">
					<div class="">
						<NuxtLink to="/jackpot-games" class="cas-btn">
							{{ msgTranslate?.see_more || 'See More' }} {{ msgTranslate?.jackpot_games || 'Jackpot Games' }}
					...
					<div class="">
						<div class="show show-first first-content-border">
							...
							<div class='mask'>
								<a :href="regLink" target="_blank">
									<div class="gameDescr">
										<div v-if="jackpotGame && game.description && game.description.length > 0"
...
await useAsyncData('jackpot-games-data', async () => {
	try {
		await loadLang();
