		...
		<div class="row bgr_red lg:mb-4">
			<div class="container grid grid-cols-1 lg:grid-cols-8 lg:gap-10 items-center mx-auto p-4">
				<div class="col-span-full lg:col-span-6">
					<p class="gamesSectionHead text-center lg:text-left">{{ msgTranslate.casino_games }}</p>
				</div>
				<div class="lg:block lg:col-span-2">
					<div class="">
						<NuxtLink to="/casino-games" class="cas-btn">
							{{ msgTranslate.see_more }} {{ msgTranslate.casino_games }}
					...
					<div class="">
						<div class="show show-first first-content-border">
							<a :href="regLink" target="_blank">
								<img class="responsive-img item-qqq" :src="game.image" @error="game.image = 'newGameImg.jpg'" 
...
import { fetchGames, games, casinoGames, msgTranslate, regLink, loginLink } from '~/composables/globalData';
// Define emit
